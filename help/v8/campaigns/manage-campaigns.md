...
キャンペーンにアクセスし管理するには、左側のナビゲーションで&#x200B;**[!UICONTROL キャンペーン]**&#x200B;メニューをクリックします。 次の 2 つのタブを使用できます。
...
「**[!UICONTROL 参照]**」タブには、キャンペーンの現在のステータス、開始日と終了日、作成日、最終更新日時に関する情報が表示されます。リストの右上隅にある「**カスタムレイアウトの列を設定**」アイコンをクリックすると、表示される列をカスタマイズできます。これにより、列の追加や削除、キャンペーンリスト内の情報の並べ替えが可能になります。

### 在庫の検索 &amp; フィルタリング{#search-and-filter}

検索バーとフィルターを使用して、リスト内での検索を簡単にすることができます。[詳細情報](../get-started/user-interface.md#list-screens)。 例えば、キャンペーンスケジュールに基づいてフィルタリングできます。 フィルターパネルを開き、「**開始日から終了日**」セクションを使用します。

![説明：開始日と終了日でキャンペーンをフィルタリングするオプションを示すフィルターパネル](assets/campaign-filter-on-dates.png)

### タイムラインビュー {#timeline}

デフォルトでは、キャンペーン画面には&#x200B;**リストビュー**（在庫）が表示されます。表示切替スイッチを使用すると、いつでも&#x200B;**タイムラインビュー**&#x200B;に切り替えることができます。両方のビューに同じキャンペーンが表示され、同じフィルターと検索機能が共有されます。一方のビューでフィルターや検索を変更すると、もう一方のビューに同じ選択が反映されます。

タイムラインビューを使用すると、キャンペーンの推移を視覚化および管理できます。すべてのキャンペーンを時間ベースの形式でで表示できるので、マーケティングアクティビティの計画、スケジュール、調整が簡単になります。

![](assets/timeline-view.png)

**タイムラインの仕組み：**

* タイムラインには、キャンペーンの開始日と終了日に応じてキャンペーンが表示されます。複数の日にまたがるキャンペーンは、関連する日付をまたいで表示されます。
* 週、月、日単位で移動できます。期間の間を移動するには、日付セレクターまたは矢印ボタンを使用します。 「**今日**」ボタンを使用すると、現在の日付にすばやく戻ることができます。
*  キャンペーンを選択すると、キャンペーンの詳細（ステータス、開始日と終了日、ワークフローのリスト、配信のリスト）を含む右側のパネルが開きます。パネルからこれらのワークフローと配信に移動できます。
* 処理中のキャンペーンは、多くのキャンペーンが同じ日付に該当する場合、ディスプレイで優先順位が付けられます。
* 多くのキャンペーンが 1 日に該当する場合（例えば、月表示）、**詳細**&#x200B;コントロールを使用すると、詳細を表示するために、その日の完全なセットを表示するように拡張したり、週表示や日表示に切り替えたりできます。
