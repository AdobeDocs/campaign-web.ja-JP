...
キャンペーンテンプレートには事前設定済みの設定が含まれており、これを新しいワークフローの作成に再利用できます。 組み込みのテンプレートを使用して作業を開始できます。 キャンペーンテンプレートを作成および設定して、そのテンプレートからキャンペーンを作成することができます。
...
1. 使用する&#x200B;**テンプレート**&#x200B;を選択し、キャンペーンのラベルを入力します。これにより、既に作成済みのテンプレートを基に新しいテンプレートを作成できます。
