...
>title="送信のスケジュール設定"
>abstract="メッセージを送信する日付と正確な時刻を定義します。 マーケティングメッセージに最も適した時間を選択することで、開封率を最大化します。"

メッセージを送信する日付と正確な時刻を設定できます。 マーケティングメッセージに最も適した時間を選択することで、開封率を最大化します。

配信の送信をスケジュールするには、配信を開き、 **スケジュール** 」セクションに入力します。 以下を使用します。 **[!UICONTROL スケジュールを有効にする]** を切り替えて有効にし、送信する日時を設定します。 配信を送信すると、実際の送信は、定義した連絡日に開始されます。
