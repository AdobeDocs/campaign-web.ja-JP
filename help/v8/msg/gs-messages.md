---
audience: end-user
title: Adobe Campaign Web でのメッセージと配信の概要
...
Adobe Campaign v8 には、E メール、SMS、プッシュ通知の各配信チャネルが付属しています。 アプリ内メッセージ、ダイレクトメール、X を使用したソーシャルマーケティング (Twitter) などの他のチャネルは、まだサポートされていません。
