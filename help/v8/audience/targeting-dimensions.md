...
ターゲティングディメンションを使用すると、操作のターゲットとなる母集団（受信者、契約受益者、オペレーター、サブスクライバーなど）を定義できます。フィルターディメンションを使用すると、メインターゲティングディメンションを変更せずに関連データを参照することで、この母集団にフィルターを適用できます。 例えば、契約加入者やニュースレターサブスクライバーなど、特定の条件に基づいて母集団を選択できます。
