...
カスタムオペレーターグループに割り当てられ、オーディエンスの作成時に「権限がありません」というエラーが発生した場合は、オペレーターグループにこのフォルダーに対する必要な権限があることを確認する必要があります。

これを解決するには、管理者が Campaign コンソールのフォルダーセキュリティ セクションにカスタムオペレーターグループを追加する必要があります。 [&#x200B; フォルダーに対する権限の管理方法については、こちらを参照してください &#x200B;](../get-started/permissions.md#folder-permissions)
