...
>title="フィルターを保存"
>abstract="この画面では、ルールを定義済みフィルターとして保存できます。 新しい定義済みフィルターを作成するか、既存のフィルターを上書きできます。 フィルターをお気に入りとして保存するには、「**[!UICONTROL お気に入りフィルター]** オプションをオンに切り替えます。 また、「**[!UICONTROL 共有フィルター]** オプションを有効にして、他のユーザーがフィルターにアクセスできるようにします。"
