...
For information specific to Adobe AI policies in Experience Cloud apps and solutions, refer to [this page](https://business.adobe.com/jp/ai.html){target="_blank"}.
-->
...
[コンテキストヘルプの質問候補の例](assets/do-not-localize/suggested-questions.png){width="600"}{zoomable="yes"}
...
[コンテキストヘルプで回答をコピーする例](assets/do-not-localize/copy-answer.png){width="600"}{zoomable="yes"}
