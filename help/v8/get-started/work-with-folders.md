...
フォルダーに対して実行できるアクションは、そのフォルダーに対して付与されている権限によって異なります。 保有している権限によっては、**[!UICONTROL フォルダー設定]**&#x200B;ダイアログが&#x200B;**読み取り専用モード**&#x200B;で開き、一部のアクションや項目が使用できない場合があります。

フォルダーに対する権限が不足している場合は、管理者にお問い合わせください。 フォルダー権限の管理方法について詳しくは、この[節](permissions.md#folder-permissions)を参照してください。

**[!UICONTROL フォルダーを挿入]**、**[!UICONTROL フォルダーを編集]**、**[!UICONTROL フォルダーを削除]**&#x200B;などのネームド権限も、オペレーターが使用できるフォルダーアクションを決定します。 [Campaign v8 ドキュメント](https://experienceleague.adobe.com/docs/campaign/campaign-v8/permissions/manage-permissions.html?lang=ja#use-named-rights){target="_blank"}を参照してください。
