...
Adobe Campaign Classic v7 のサポート終了日について詳しくは、[製品およびテクニカルサポート期間](https://helpx.adobe.com/jp/support/programs/eol-matrix.html){target="_blank"}ページを参照してください。
