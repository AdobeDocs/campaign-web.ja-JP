...
現在、新しい Campaign web UI 内のベータ版としてリリースされている、コンテキストヘルプに組み込まれた **AI を活用したナレッジアシスタント**&#x200B;は、膨大なドキュメントリポジトリを簡単に検索して、必要な正確な情報を即座に特定できるので、ドキュメントの検索と操作方法に関する質問への回答に大変革をもたらします。
