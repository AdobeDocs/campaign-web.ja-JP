---
audience: end-user
title: AI アシスタントコンテンツアクセラレータを使用したプッシュ通知
...
# AI アシスタントコンテンツアクセラレータを使用したプッシュ通知の生成 {#generative-push}
...
AI アシスタントコンテンツアクセラレータは、オーディエンスの共感を呼ぶ可能性の高い、別のコンテンツを提案し、配信の影響を最適化するのに役立ちます。
