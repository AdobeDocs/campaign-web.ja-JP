...
![ 使用可能なテンプレートを示すメールDesignerインターフェイス ](assets/email_designer-templates.png){zoomable="yes"}

次から選択できます。

* **サンプルテンプレート**。Campaign には、選択可能な一連の組み込みテンプレートが付属しています。

* **保存済みテンプレート**。既存のコンテンツからテンプレートとして保存したカスタムテンプレートを使用することもできます。

テンプレートの使用方法と、メールコンテンツをテンプレートとして保存する方法については、以下の節を参照してください。

>[!NOTE]
>
>メールコンテンツテンプレートは、[配信テンプレート](../msg/delivery-template.md)とは異なります。メールコンテンツのみを再利用できますが、配信テンプレートでは、配信コンテンツのほか、タイポロジ、送信者アドレス、オーディエンスなど、すべての配信設定とプロパティを再利用できます。
...
1. 既存のカスタムテンプレートを使用するには、「**[!UICONTROL 保存済みのテンプレート]**」タブを参照します。
   ...
   ![ メールDesignerの「保存済みのテンプレート」タブ ](assets/email_designer-saved-templates-tab.png){zoomable="yes"}

1. すべての[保存済みのテンプレート](#save-as-template)のリストが表示されます。**[!UICONTROL 名前別]**、**[!UICONTROL 最終変更日]** および **[!UICONTROL 最終作成日]** で並べ替えることができます。

   ![ メールDesignerに保存されたテンプレートのリスト ](assets/email_designer-saved-templates.png){zoomable="yes"}

1. リストからテンプレートを選択して、そのコンテンツを表示します。

1. 左右の矢印を使用して、（選択内容に応じてサンプルまたは保存済みの）テンプレート間を移動します。

   ![ メールDesignerのテンプレートのナビゲーション矢印 ](assets/email_designer-saved-templates-navigate.png){zoomable="yes"}
