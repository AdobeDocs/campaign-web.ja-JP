...
1. 新しい配信を作成するには、 **[!UICONTROL 配信]** 左側のパネルのメニューで、  **[!UICONTROL 配信を作成]** 」ボタンをクリックします。

1. 選択 **[!UICONTROL 電子メール]** をチャネルとして選択し、テンプレートを選択します。
...
1. 次をクリック： **[!UICONTROL 配信を作成]** ボタンをクリックして確定します。
...
1. E メールコンテンツの作成を開始するには、E メール配信を開き、 **[!UICONTROL コンテンツを編集]** 」ボタンをクリックします。
...
1. E メールのコンテンツをデザインするには、 **[!UICONTROL メール本文を編集]** 」ボタンをクリックします。
...
E メールの送信をスケジュールするには、E メール配信を開き、 **スケジュール** 」セクションに入力します。 以下を使用： **[!UICONTROL スケジュールを有効にする]** を切り替えて有効にし、送信する日時を設定します。 配信を送信すると、実際の送信は、定義したコンタクト日に開始されます。

デフォルトでは、 **[!UICONTROL 送信前に確認を有効にする]** 」オプションが有効になっている。 このオプションを使用する場合は、スケジュールされた日時に E メールを送信する前に、送信を確認する必要があります。 スケジュールされた日時に電子メールを自動的に送信する必要がある場合は、このオプションを無効にできます。
...
1. 電子メールを確認するには、 **[!UICONTROL 確認して送信]**. これによりメールのプレビューが、設定済みのすべてのプロパティ、オーディエンス、スケジュールと共に表示されます。「変更」ボタンをクリックして、これらの要素を編集できます。
