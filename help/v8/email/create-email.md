...
1. 新しい配信を作成するには、**[!UICONTROL 配信]**&#x200B;メニューに移動し、チャネルとして「**[!UICONTROL メール]**」を選択します。

1. 使用するテンプレートを選択し、「**[!UICONTROL 配信を作成]**」をクリックします。
...
1. メールの本文をデザインするには、「**[!UICONTROL メール本文を編集]**」ボタンをクリックします。
...
メールの送信スケジュールを設定するには、「**[!UICONTROL 有効にする]**」をクリックしてから、希望する送信日時を指定します。

デフォルトでは、「**[!UICONTROL 送信前に確認する]**」オプションが有効になっています。スケジュール設定した日時にメールを送信する前に送信を確定する必要があります。 スケジュールを設定した日時にメールを自動的に送信する場合は、このオプションを無効にします。
...
1. メールを確認して送信するには、「**[!UICONTROL 確認して送信]**」をクリックします。これによりメールのプレビューが、設定済みのすべてのプロパティ、オーディエンス、スケジュールと共に表示されます。「変更」ボタンをクリックして、これらの要素を編集できます。
