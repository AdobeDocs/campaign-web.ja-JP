...
1. E メールデザイナーで、[既存のコンテンツ](existing-content.md)を使用するか、**[!UICONTROL 構造]**&#x200B;を空のコンテンツにドラッグ＆ドロップして、メールのレイアウトを定義します。 [詳細情報](create-email-content.md)
...
1. 次のいずれかのオプションを選択して、画像を追加します。
   ...
   ![E メールデザイナーで画像コンポーネント用のオプションを示すスクリーンショット。](assets/email_designer_28.png){zoomable="yes"}

   +++**[!UICONTROL 参照]**

   このオプションを選択すると、Adobe Experience Manager Assets ライブラリから画像を選択できます。
   ...
   +++**[!UICONTROL パブリックリソースをインポート]**

   このオプションを選択すると、Adobe Campaign インスタンスで既に使用可能な画像（以前に E メールデザイナーにインポートしたファイルや、クライアントコンソールからパブリックリソースとしてインポートしたファイルなど）を選択できます。
   ...
   >[!NOTE]
   >
   >セキュリティ上の制約は、クライアントコンソールと同じです。ユーザー権限に基づいて、アクセスできるリソースのみを選択できます。

   リソースを選択してから、「**[!UICONTROL 確認]**」をクリックします。
