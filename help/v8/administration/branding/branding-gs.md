...
技術管理者は、web UI から複数のブランドを直接作成および管理できます。 これにより、ロゴやメールトラッキング設定など、ブランドアイデンティティを設定するすべての要素を定義できます。 作成したら、これらのブランドは配信に簡単にリンクできます。 [ブランドの作成および設定方法の詳細情報](branding-configure.md)。
...
![ブランド作成を示すスクリーンショット。](assets/branding-legacy.png)
