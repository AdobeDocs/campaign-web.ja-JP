...
1. リストでスキーマ名を選択して開きます。詳細なスキーマビューが表示されます。[ スキーマの詳細の詳細情報 ](../administration/schemas.md)。 **[!UICONTROL 画面編集]** ボタンをクリックして、カスタムフィールドにアクセスします。 この例では、**[!UICONTROL 受信者]**&#x200B;スキーマのフィールドを追加します。
