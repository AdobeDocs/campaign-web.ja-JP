...
+ Adobe Campaign の概要 {#start}
   ...
   + {hide-from-toc}[インターフェイスの確認](get-started/user-interface.md)
...
+ コンテンツ管理 {#content}
   ...
   + メールのデザイン {#email-design}
      ...
      + メールの作成を開始 {#start-design}
         ...
         + [メールコンテンツへのテーマの追加](email/apply-email-themes.md)
   ...
   + AI アシスタント {#ai-assistant}
      ...
      + ブランド {#ai-assistant}
         ...
         + [生成モデルの作成と管理](content/generative-models.md)
...
+ ワークフロー {#wf}
   ...
   + ワークフローアクティビティの操作 {#design-workflows}
      ...
      + [結合](workflows/activities/join.md)
