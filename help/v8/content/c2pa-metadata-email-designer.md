...
<target xml:lang="en-XX">Adobe Campaign Web ユーザーインターフェイスにおいて、画像に既に添付されている C2PA メタデータが、E メールおよびランディングページデザイナーを通過する際に行われる処理について説明します。</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>このページ：<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph>Adobe Campaign Web ユーザーインターフェイスにおいて、画像に既に添付されている C2PA メタデータが、E メールおよびランディングページデザイナーを通過する際に行われる処理について説明します。</target>
</trans-unit>
...
<target xml:lang="en-XX">生成 AI の透明性に関する新しい法律が制定されつつあり、アドビでは管轄区域をまたいｄ適用される要件への対応に取り組んでいます。C2PA メタデータは、アドビがこれらの法律の要件を満たすために使用する来歴ツールです。</target>
</trans-unit>
...
<target xml:lang="en-XX">E メールおよびランディングページデザイナーは、画像自体を生成または編集しません。コンテンツを生成、Adobe Express、Firefly などの他のアドビツールやパートナーモデルで生成 AI を使用して既に生成または編集された画像を参照します。これらの画像に既に添付されている C2PA メタデータは、作成、公開、送信を行う間も保持され、変更されません。</target>
</trans-unit>
<trans-unit id="tu10" xml:space="preserve">
<source xml:lang="en-US">C2PA metadata are preserved as you build and send</source>
<target xml:lang="en-XX">C2PA メタデータが作成および送信の際に保持される</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>テンプレートに画像を挿入<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph></target>
</trans-unit>
...
<target xml:lang="en-XX">デザイナーは、コンテンツを生成、Adobe Express、Firefly、パートナーモデルなど、他の場所で生成 AI を使用して既に生成または編集された画像への参照を追加します。画像ファイル自体は変更されません。</target>
</trans-unit>
<trans-unit id="tu18" restype="x-TABLECELL_TEXT" xml:space="preserve">
<source xml:lang="en-US">Yes, unchanged</source>
<target xml:lang="en-XX">はい、変更されません</target>
</trans-unit>
...
<target xml:lang="en-XX">Firefly で生成されたバナーが、メールテンプレートに挿入されます。</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>代替テキストをサイズ変更、再配置、追加<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph></target>
</trans-unit>
...
<target xml:lang="en-XX">テンプレートの HTML の表示プロパティのみが変更されます。画像ファイルは再エンコードされません。</target>
</trans-unit>
...
<target xml:lang="en-XX">画像はモバイルレイアウトに合わせてサイズ変更され、代替テキストが付与されます。</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>公開<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph></target>
</trans-unit>
...
<target xml:lang="en-XX">メールまたはランディングページが公開され、画像が配信用に保存されます。</target>
</trans-unit>
...
<target xml:lang="en-XX">キャンペーンが公開され、その画像が送信用に保存されます。</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>メールを送信またはランディングページを表示<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph></target>
</trans-unit>
...
<target xml:lang="en-XX">画像は受信者のインボックスに配信されるか、ライブページに表示されます。</target>
</trans-unit>
...
<target xml:lang="en-XX">受信者はメールを開いて画像をダウンロードします。資格情報は、元の資格情報と引き続き一致します。</target>
</trans-unit>
<trans-unit id="tu32" xml:space="preserve">
<source xml:lang="en-US">Content types and their scope</source>
<target xml:lang="en-XX">コンテンツタイプとその範囲</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>画像<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph>：対象。上記のように、画像に既に添付されている C2PA メタデータは、挿入、調整、公開、配信の際に保持されます。</target>
</trans-unit>
...
<target xml:lang="en-XX"><ph id="1" ctype="x-STRONG_EMPHASIS">**</ph>ビデオ、オーディオ、テキスト<ph id="2" ctype="x-STRONG_EMPHASIS">**</ph>：対象外。E メールおよびランディングページデザイナーは、生成 AI を使用して、これらのコンテンツタイプの生成や編集を行いません。</target>
</trans-unit>
<trans-unit id="tu35" xml:space="preserve">
<source xml:lang="en-US">What happens as your content moves</source>
<target xml:lang="en-XX">コンテンツが移動する際の取り扱い</target>
</trans-unit>
...
<target xml:lang="en-XX">C2PA メタデータは、Adobe Campaign Web ユーザーインターフェイスにおいて、ディターからストレージ経由で受信者のインボックスやライブページへと、画像と共に E メールおよびランディングページデザイナー内を移動します。これらの手順のいずれでも、資格情報は作成、変更、削除されません。</target>
</trans-unit>
...
<target xml:lang="en-XX">画像が生成 AI を使用して生成または編集されておらず、その画像に生成 AI に関する C2PA メタデータが含まれていない場合、ここにはその画像に関する資格情報が表示されません。これは想定されており、エラーではありません。</target>
</trans-unit>
<trans-unit id="tu38" xml:space="preserve">
<source xml:lang="en-US">Checking a credential</source>
<target xml:lang="en-XX">資格情報の確認</target>
</trans-unit>
...
<target xml:lang="en-XX">E メールおよびランディングページデザイナー内で Content Credential を直接確認する方法はまだありません。</target>
</trans-unit>
<trans-unit id="tu40" xml:space="preserve">
<source xml:lang="en-US">Additional resources</source>
<target xml:lang="en-XX">その他のリソース</target>
</trans-unit>
