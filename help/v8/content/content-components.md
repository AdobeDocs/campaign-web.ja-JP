...
1. メールデザイナーで、既存のコンテンツを使用するか、**[!UICONTROL 構造]**&#x200B;を空のコンテンツにドラッグ＆ドロップして、メールのレイアウトを定義します。方法については、[こちら](create-email-content.md)を参照してください。

1. 選択した&#x200B;**[!UICONTROL コンテンツ]**&#x200B;を、関係のある構造コンポーネント内にドラッグ＆ドロップします。
...
1. 「**[!UICONTROL 設定]**」タブと「**[!UICONTROL スタイル]**」タブを使用して、各コンポーネントのスタイル属性を調整します。例えば、各コンポーネントのテキストスタイル、パディングまたは余白を変更できます。 [詳しくは、整列とパディングを参照してください](alignment-and-padding.md)

   ![](assets/email_designer_content_components_settings.png)

メールコンテンツをゼロから作成する場合は、**[!UICONTROL コンテンツ]**コンポーネントを使用すると、メールに配置して使用できる生の空コンポーネントでメールをさらにパーソナライズできます。
メールのレイアウトを定義する**[!UICONTROL 構造]**&#x200B;コンポーネント内には、**[!UICONTROL コンテンツ]**&#x200B;コンポーネントを必要な数だけ追加できます。
...
1. ボタンをさらにパーソナライズするには、「**[!UICONTROL 境界線]**」、「**[!UICONTROL サイズ]**」、「**[!UICONTROL 余白]**」などのスタイル属性を「**[!UICONTROL 設定]**」タブと「**[!UICONTROL スタイル]**」タブから。
...
1. その他のスタイル属性（テキストの色、フォントファミリー、境界線、パディング、余白など）を「**[!UICONTROL 設定]**」タブと「**[!UICONTROL スタイル]**」タブから。
...
1. 新しく追加したコンポーネントをクリックし、「**[!UICONTROL 設定]**」タブと「**[!UICONTROL スタイル]**」タブを使用して画像プロパティを設定します。
...
1. 余白、境界線など、他のスタイル属性を調整、または、オーディエンスを別のコンテンツにリダイレクトするリンクを追加します。
...
1. スタイル、余白、境界線など、他のスタイル属性を「**[!UICONTROL 設定]**」タブと「**[!UICONTROL スタイル]**」タブから。
