...
>
>* リッチ プッシュ通知をデザインする前に、まず V2 コネクタを設定する必要があります。 詳しい手順は、[ このページ ](https://experienceleague.adobe.com/ja/docs/campaign-classic/using/sending-messages/sending-push-notifications/configure-the-mobile-app/configuring-the-mobile-application-android#configuring-external-account-android){target="_blank"} を参照してください。
...
1. **[!UICONTROL 追加アイコン]** をクリックし、**画像 URL** と **[!UICONTROL リンク URI]** を入力して **[!UICONTROL リンクタイプ]** を選択します。

   最低 3 つのアイコン、最大 5 つのアイコンを含めてください。
...
1. **クリックしてアクションを実行するテキスト** と **画像** を入力します。

1. 「水平」または「垂直」から **[!UICONTROL 表示タイプ]** を選択します。

1. **[!UICONTROL カタログ]** の項目情報を入力します。

   必ず、少なくとも 3 つの項目、最大 5 つの項目を含めてください。
...
1. **[!UICONTROL 評価アイコンを選択されていない状態で]** 追加し、**[!UICONTROL 評価アイコンを選択されている状態で]** URL を追加します。

   ![](assets/rich_push_rating_3.png)

1. 「**[!UICONTROL 評価を追加]**」をクリックし、**[!UICONTROL リンク URI]** と **[!UICONTROL リンクタイプ]** を入力します。

   評価に最低 3 つ、最高 5 つがあることを確認してください。
...
1. **[!UICONTROL 代替タイトル]**、**[!UICONTROL 代替メッセージ]**、**[!UICONTROL 代替の展開メッセージ]**、**[!UICONTROL 代替の起動画像]** フィールドに、タイマーの期限が切れた後に表示されるテキストと画像を入力します。
...
1. 通知で主に画像とテキストを表示するか、非表示の通知スタイル ]**を選択します**[!UICONTROL 。
...
| **[!UICONTROL タイマ カラー]** | 16 進数のカラーコードでタイマーの色を設定します。 |
