...
10 月リリースが公開されました。 トランザクションメッセージの多言語機能、プッシュ通知と SMS、Adobe GenStudioとの統合、トランザクションメッセージのプロファイルエンリッチメントなど、Campaign web ユーザーインターフェイスの新機能と機能強化が追加されました。 概要の全文について詳しくは、リリースノートを参照してください。
