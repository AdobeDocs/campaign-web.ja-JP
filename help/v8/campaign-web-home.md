...
3月リリースは公開中です。 Campaign Web ユーザーインターフェイスで新しい機能と機能強化が利用可能になりました。 主な内容：

* **スキーマオーサリング（GA）** - Campaign Web UIで直接スキーマを作成および管理します。
* メール Designer （LA）の&#x200B;**テーマ** – 再利用可能なテーマのスタイルと変数を適用して、メールコンテンツをブランドに合わせて維持します。
* **ワークフローの機能強化** - **自動配信**&#x200B;および&#x200B;**開始** アクティビティが利用可能になり、**参加**&#x200B;でOR オプションがサポートされるようになりました。 ワークフローに複数の分岐を追加することもできます。
