...
Adobe Campaign web インターフェイスと Adobe Experience Manager as a Cloud Service の統合により、メールコンテンツ管理が効率化されます。Adobe Experience Manager でメールコンテンツを直接作成および編集し、完成したテンプレートを Adobe Campaign にシームレスにインポートして配信できるようになりました。
