...
クエリにコンポーネントを追加する際、ドラッグ＆ドロップ機能を使用してコンポーネントを上下に移動できます。

各コンポーネントの左側にあるドットをクリックして押したままにすると、コンポーネントを配置およびグループ化する場所に応じてコンポーネントを上下にドラッグできます。
...
新しいルールビルダーエクスペリエンスを使用する際に、各条件とグループにターゲット母集団を直接表示できます。

* クエリのターゲットとなるレコード数を計算して表示するには、目的の条件またはグループの **条件を計算** アイコンをクリックします。
