...
ワークフローメニューまたはキャンペーン内のどちらで [ ワークフローを作成 ](create-workflow.md) したら、実行される様々なタスクの調整を開始できます。 これを行うために、ワークフローダイアグラムを構築できる視覚的なキャンバスが用意されています。このダイアグラムに様々なアクティビティを追加し、順番に接続できます。
...
![ ワークフロー開始アイコンとアクティビティのオプション ](assets/workflow-start.png){zoomable="yes"}
...
![ ワークフローキャンバスのツールバーオプション ](assets/workflow-toolbar.png){zoomable="yes"}{width="50%"}
...
![ 補集合オプション付き分割アクティビティ ](assets/workflow-split-complement.png)
...
* アクションボタンを使用してアクティビティを 1 つコピーします。
  ...
  ![ 「単一のアクティビティをコピー」ボタン ](assets/workflow-copy.png){zoomable="yes"}{width="70%"}
...
![ 「コピーしたアクティビティを貼り付け」オプション ](assets/workflow-copy-3.png){zoomable="yes"}{width="50%"}
...
![ アクティビティと子ノードを移動 ](assets/activity-move.png)
...
![ ワークフローのサンプルダイアグラム ](assets/workflow-example.png){zoomable="yes"}
...
ワークフローを完了したら、ダイアグラムの最後に **[!UICONTROL 終了]** アクティビティを追加します。 このアクティビティは、ワークフローの終了を視覚的に示すもので、機能には影響しません。

ワークフローダイアグラムのデザインが完了したら、ワークフローを実行し、様々なタスクの進行状況を追跡します。 [ ワークフローを開始し、その実行を監視する方法を説明します ](start-monitor-workflows.md)。