...
>[!IMPORTANT]
>
>変更 Dimension ]**と**[!UICONTROL &#x200B;変更 データソース&#x200B;]**アクティビティを**[!UICONTROL  1 行に追加しないでください。両方のアクティビティを連続して使用する必要がある場合は、それらの間にエンリッチメント&#x200B;]**アクティビティを含め**[!UICONTROOL &#x200B;てください。これにより、適切な実行が保証され、潜在的な競合やエラーが防止されます。
