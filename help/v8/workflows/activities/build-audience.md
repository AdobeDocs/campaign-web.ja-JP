...
1. ターゲティングディメンションの横にあるアイコンをクリックして、「**フィルタリングディメンション**」を選択します。 フィルタリングディメンションを使用すると、メインのターゲティングディメンションを変更せずに、関連する条件を参照することで、ターゲット母集団にフィルターを適用できます。 [ターゲティングディメンションについての詳細を学ぶ](../../audience/targeting-dimensions.md#filtering)
1. 「**続行**」をクリックします。
