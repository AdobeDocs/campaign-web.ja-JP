...
1. 「**エンリッチメントデータ**」セクションを使用して、契約参照やニュースレター購読など、データベースからの追加情報でターゲットデータを強化します。 そのデータは、ワークフロー&#x200B;**ワークテーブル**&#x200B;のオーディエンスと共に保存され、後のアクティビティで使用できます。 単一のエンリッチメント属性、コレクションリンク、またはエクスプレッションを追加し、詳細オプションにアクセスできます。 詳細な手順と例については、[ エンリッチメントデータの追加](enrichment.md#enrichment-add)を参照してください。
