...
これを行うには、次の手順に従って、**[!UICONTROL エンリッチメント]** アクティビティをオファーで設定します。
...
1. オファーの選択には、次の 2 つの選択肢があります。
   ...
   * **[!UICONTROL カテゴリ内で最適なオファーを検索]**：このオプションをオンにする場合は、オファーエンジン呼び出しのパラメーター（オファースペース、カテゴリまたはテーマ、コンタクト日、保持するオファーの数）を指定します。 エンジンは、これらのパラメーターに従って、追加する最適なオファーを計算します。 カテゴリまたはテーマフィールドを、両方を同時に入力するのではなく、いずれか一方を入力することをお勧めします。
...
### エンリッチメントからのオファーの使用アクティビティ

ワークフロー内で、配信のエンリッチメントアクティビティから取得したオファーを使用する場合は、次の手順に従います。
...
1. E メールデザイナーで、オファーを含むパーソナライゼーションを追加する際に、**[!UICONTROL 提案]** アイコンをクリックすると、**[!UICONTROL エンリッチメント]** アクティビティから取得したオファーが表示されます。 選択するオファーをクリックして開きます。
   ...
   **[!UICONTROL レンダリング関数]** を開き、必要に応じて **[!UICONTROL HTMLレンダリング]** または **[!UICONTROL テキストレンダリング]** を選択します。

   ![](../assets/offers-rendering.png)

>[!NOTE]
>
>「**[!UICONTROL 保持するオファーの数**[!UICONTROL  オプションの「エンリッチメント ]**」アクティビティに複数のオファーを選択した場合]** 「**[!UICONTROL 提案]**」アイコンをクリックすると、すべてのオファーが表示されます。
...
以下に示すように、属性をわかりやすくするために、属性の **Label** フィールドと **Alias** フィールドを使用します。
