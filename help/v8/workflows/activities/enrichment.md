...
「**エンリッチメントデータ**」セクションは、**エンリッチメント**&#x200B;および&#x200B;**オーディエンスの構築** （クエリタイプ）アクティビティで利用できます。 契約参照やニュースレター購読など、データベースからの追加情報を使用して、ターゲットデータを強化できます。 そのデータは、ワークフローの&#x200B;**作業用テーブル**&#x200B;のオーディエンスと共に保存され、後続のアクティビティで使用できます。 単一のエンリッチメント属性、コレクションリンク、またはエクスプレッションを追加し、詳細オプションにアクセスできます。
