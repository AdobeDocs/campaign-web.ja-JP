...
* **アップグレードされたプッシュインフラストラクチャ**
  ...
  [アップグレードされたプッシュインフラストラクチャの詳細を表示する](https://experienceleague.adobe.com/ja/docs/campaign/campaign-v8/send/push/push-data-collection){target="_blank"}。
...
Campaign v8 への移行をスムーズに行うために、Campaign v8 に Campaign Standard の主な機能が追加されました。 詳しくは、[このドキュメント](../../v8/rn/acs-migration.md)を参照してください。
